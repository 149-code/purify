...
let s:green = {"gui": "#00ff87", "cterm": 48}
...
let s:purple = {"gui": "#875fff", "cterm": 99}
...
let s:gutter_grey_fg = {"gui": "#bcbcbc", "cterm": 250}
...
call s:hi('Constant',       { 'fg': s:salmon })
call s:hi('String',         { 'fg': s:salmon })
call s:hi('Character',      { 'fg': s:salmon })
...
call s:hi('ErrorMsg',     { 'fg': s:white })
call s:hi('VertSplit',    { 'fg': s:purple })
...
call s:hi('PmenuSel',     { 'fg': s:blue, 'bg': s:blue })
call s:hi('PmenuSbar',    { 'bg': s:blur_grey })
call s:hi('PmenuThumb',   { 'bg': s:comment_grey })
call s:hi('Question',     { 'fg': s:comment_grey })
...
call s:hi('cFormat',           { 'fg': s:purple })
call s:hi('cString',           { 'fg': s:purple })
call s:hi('cCppString',        { 'fg': s:purple })
